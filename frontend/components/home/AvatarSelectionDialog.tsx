...
const AvatarSelectionDialog: React.FC<AvatarSelectionDialogProps> = ({ visible, onClose, onSave, avatars }) => {
                    ...
                    {avatars.map((avatar) => (
                        <TouchableOpacity
                            ...
                            style={[
                                ...
                                selectedAvatar && selectedAvatar.id === avatar.id && styles.selectedAvatarContainer,
                            ]}
                        ...
                        >
                            ...
                            <View style={styles.priceContainer}>
                                {avatar.price !== 'FREE' && (
                                    <Image source={getDiamondImage(avatar.price)} style={styles.diamondIcon} />
                                )}
                                <Text style={styles.price}>{avatar.price}</Text>
                            </View>
                            {selectedAvatar && selectedAvatar.id === avatar.id && <Text style={styles.selected}>Selected</Text>}
                        </TouchableOpacity>
                    ))}
                </View>
